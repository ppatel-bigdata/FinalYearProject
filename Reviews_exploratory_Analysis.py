...
df = sns.FacetGrid(data = yelp_reviews, col = 'Customer FEEDBACK', hue = 'Customer FEEDBACK', palette='husl', height=5)
...
print("The number reviews that tend to be more close to the factual informations base on the Sentiment Analysis are ", k)
